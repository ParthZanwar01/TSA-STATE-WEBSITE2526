        ...
        <div className="flex flex-col md:flex-row gap-4 mb-8">
          ...
          <div className="relative w-full md:w-80">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-lg border border-border bg-card text-foreground text-sm placeholder:text-muted-foreground outline-none focus:ring-2 focus:ring-gold/30"
            />
          </div>
        </div>
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-xl overflow-hidden" style={{ backfaceVisibility: 'hidden' }}>
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-5">
                      ...
                      <div className="flex items-center gap-1 mt-1 text-primary-foreground/60 text-xs">
                        ...
                        <span className="ml-auto text-gold text-xs">Click to Flip →</span>
                      </div>
                    </div>
                  </div>
                  ...
                  {/* Back */}
                  <div
                    className="absolute inset-0 rounded-xl bg-card border border-border p-6 flex flex-col justify-between"
