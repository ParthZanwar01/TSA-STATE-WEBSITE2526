...
export const businesses: Business[] = [
  ...
  { id: "biz_rest_004", name: "BBQ Pit Masters", category: "Restaurant", rating: 4.7, reviewCount: 16, address: "369 Smoke Ring Road", description: "Slow-smoked Texas BBQ. Brisket, ribs, sausage and all the fixings.", image: "https://images.unsplash.com/photo-1529193591184-b1d58069ecdd?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.982, lng: -95.6444 },
  { id: "biz_rest_005", name: "Burger Barn", category: "Restaurant", rating: 4.5, reviewCount: 20, address: "789 Patty Lane", description: "Gourmet burgers made with local grass-fed beef. Craft shakes and loaded fries.", image: "https://images.unsplash.com/photo-1568901346375-23c9450c58cd?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9824, lng: -95.645 },
  ...
  { id: "biz_rest_007", name: "Pho King Vietnamese", category: "Restaurant", rating: 4.6, reviewCount: 14, address: "234 Noodle Way", description: "Traditional Vietnamese pho and banh mi. Authentic family recipes since 1998.", image: "https://images.unsplash.com/photo-1582878826629-29b7ad1cdc43?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.9816, lng: -95.6438 },
  ...
  { id: "biz_rest_009", name: "Sunrise Breakfast Café", category: "Restaurant", rating: 4.8, reviewCount: 31, address: "101 Morning Street", description: "Farm-fresh breakfast and brunch. Best pancakes in Cypress.", image: "https://images.unsplash.com/photo-1533089860892-a7c6f0a88666?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.9828, lng: -95.6455 },
  ...
  { id: "biz_rest_015", name: "Wings & Things", category: "Restaurant", rating: 4.3, reviewCount: 21, address: "456 Buffalo Blvd", description: "50+ wing flavors. Sports bar with 30 screens.", image: "https://images.unsplash.com/photo-1567620832903-9fc6debc209f?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.9814, lng: -95.6444 },
  ...
  { id: "biz_rest_019", name: "India Palace", category: "Restaurant", rating: 4.6, reviewCount: 10, address: "890 Spice Road", description: "Traditional Indian cuisine with a modern twist. Lunch buffet daily.", image: "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9726, lng: -95.6199 },
  ...
  { id: "biz_ret_002", name: "Cozy Corner Bookstore", category: "Retail", rating: 4.6, reviewCount: 9, address: "321 Reader Lane", description: "Independent bookstore with curated selection and cozy reading nooks.", image: "https://images.unsplash.com/photo-1526243741027-444d633d7365?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.9718, lng: -95.6187 },
  ...
  { id: "biz_ret_009", name: "Green Thumb Garden Center", category: "Retail", rating: 4.5, reviewCount: 20, address: "456 Plant Way", description: "Native Texas plants, trees, and landscaping supplies. Expert garden advice.", image: "https://images.unsplash.com/photo-1416879595882-3373a0480b5b?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9714, lng: -95.6195 },
  { id: "biz_ret_010", name: "Cypress Sports & Collectibles", category: "Retail", rating: 4.4, reviewCount: 12, address: "789 Trophy Lane", description: "Sports memorabilia, trading cards, and fan gear for all Houston teams.", image: "https://images.unsplash.com/photo-1461896836934-bd45ba8a0a56?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9734, lng: -95.6211 },
  ...
  { id: "biz_ret_012", name: "Cypress Wine & Spirits", category: "Retail", rating: 4.7, reviewCount: 25, address: "567 Vineyard Blvd", description: "Curated wine selection, craft spirits, and weekly tasting events.", image: "https://images.unsplash.com/photo-1516594915697-87eb3b1c14ea?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.971, lng: -95.6188 },
  ...
  { id: "biz_fit_002", name: "Aqua Fitness Center", category: "Health & Fitness", rating: 4.4, reviewCount: 22, address: "222 Splash Lane", description: "Olympic-size pool, water aerobics, and swim lessons.", image: "https://images.unsplash.com/photo-1576013551627-0cc20b96c2a7?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9728, lng: -95.6182 },
  ...
  { id: "biz_fit_005", name: "Iron Works Gym", category: "Health & Fitness", rating: 4.5, reviewCount: 30, address: "789 Muscle Blvd", description: "Full gym with free weights, machines, and personal training.", image: "https://images.unsplash.com/photo-1540497077202-7c8a3999166f?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.9812, lng: -95.6441 },
  { id: "biz_fit_006", name: "Dance Fusion Studio", category: "Health & Fitness", rating: 4.6, reviewCount: 12, address: "234 Rhythm Road", description: "Zumba, hip-hop, ballet, and salsa classes for all ages.", image: "https://images.unsplash.com/photo-1508700929628-666bc8bd84ea?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9716, lng: -95.6205 },
  ...
  { id: "biz_beauty_004", name: "Glow Skin Bar", category: "Beauty & Spa", rating: 4.8, reviewCount: 10, address: "456 Radiance Road", description: "Advanced skincare treatments. Facials, peels, and microneedling.", image: "https://images.unsplash.com/photo-1570172619644-dfd03ed5d881?w=600&h=400&fit=crop", priceRange: "$$$", isOpen: true, lat: 29.972, lng: -95.6218 },
  { id: "biz_beauty_005", name: "The Barber Lounge", category: "Beauty & Spa", rating: 4.7, reviewCount: 28, address: "789 Clipper Blvd", description: "Classic barbershop experience. Straight razor shaves and craft cuts.", image: "https://images.unsplash.com/photo-1503951914875-452162b0f3f1?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.983, lng: -95.6448 },
  ...
  { id: "biz_beauty_008", name: "Color Me Beautiful Salon", category: "Beauty & Spa", rating: 4.6, reviewCount: 19, address: "890 Style Street", description: "Hair color specialists. Balayage, highlights, and vivid color experts.", image: "https://images.unsplash.com/photo-1562322140-8baeececf3df?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9704, lng: -95.6194 },

  // ── AUTOMOTIVE (7) ──
  { id: "biz_auto_001", name: "Premier Auto Care", category: "Automotive", rating: 4.6, reviewCount: 112, address: "321 Industrial Blvd", description: "Trusted auto repair and maintenance. ASE certified mechanics, fair prices, and honest service since 1998.", image: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9643, lng: -95.6098, phone: "(555) 456-7890" },
  { id: "biz_auto_002", name: "Cypress Auto Care", category: "Automotive", rating: 4.6, reviewCount: 32, address: "123 Motor Lane", description: "Full-service auto repair and maintenance. ASE certified mechanics.", image: "https://images.unsplash.com/photo-1487754180451-c456f719a1fc?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9647, lng: -95.6105 },
  ...
  { id: "biz_auto_004", name: "Sparkle Car Wash", category: "Automotive", rating: 4.4, reviewCount: 38, address: "789 Clean Street", description: "Full-service car wash and detailing. Monthly unlimited plans available.", image: "https://images.unsplash.com/photo-1520340356584-f9917d1eea6f?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.9639, lng: -95.6091 },
  { id: "biz_auto_005", name: "Tire Town", category: "Automotive", rating: 4.5, reviewCount: 21, address: "234 Rubber Road", description: "New and used tires. Alignments, balancing, and brake service.", image: "https://images.unsplash.com/photo-1580273916550-e323be2ae537?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9818, lng: -95.6462 },
  ...
  { id: "biz_auto_007", name: "Custom Wheels & Audio", category: "Automotive", rating: 4.7, reviewCount: 9, address: "890 Chrome Blvd", description: "Custom wheels, audio systems, and vehicle accessories.", image: "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?w=600&h=400&fit=crop", priceRange: "$$$", isOpen: true, lat: 29.9651, lng: -95.6112 },

  // ── SERVICES (10) ──
  { id: "biz_svc_001", name: "Ace Hardware & Supply", category: "Services", rating: 4.5, reviewCount: 15, address: "444 Builder Road", description: "Your neighborhood hardware store. Tools, paint, plumbing supplies, and helpful advice.", image: "https://images.unsplash.com/photo-1504148455328-c376907d081c?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9635, lng: -95.61 },
  { id: "biz_svc_002", name: "Bright Smile Dentistry", category: "Services", rating: 4.4, reviewCount: 19, address: "555 Medical Center Dr", description: "Family dentistry with a gentle touch. Cleanings, cosmetic, and orthodontics.", image: "https://images.unsplash.com/photo-1629909613654-28e377c37b09?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9823, lng: -95.6432 },
  { id: "biz_svc_003", name: "Cypress Tax Professionals", category: "Services", rating: 4.7, reviewCount: 11, address: "123 Finance Way", description: "Personal and business tax preparation. Year-round accounting services.", image: "https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?w=600&h=400&fit=crop", priceRange: "$$", isOpen: true, lat: 29.9655, lng: -95.6095 },
  { id: "biz_svc_004", name: "Print & Ship Center", category: "Services", rating: 4.3, reviewCount: 16, address: "456 Postal Plaza", description: "Printing, copying, shipping, and mailbox rental. Notary services.", image: "https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=600&h=400&fit=crop", priceRange: "$", isOpen: true, lat: 29.9631, lng: -95.6088 },
  ...
  { id: "biz_np_005", name: "Senior Services Center", category: "Non-Profit", rating: 4.8, reviewCount: 11, address: "123 Golden Years Blvd", description: "Activities, meals, and support services for seniors. Transportation available.", image: "https://images.unsplash.com/photo-1517457373958-b7bdd4587205?w=600&h=400&fit=crop", priceRange: "Free", isOpen: true, lat: 29.9671, lng: -95.6108 },
  { id: "biz_np_006", name: "Cypress Literacy Council", category: "Non-Profit", rating: 4.6, reviewCount: 8, address: "456 Reading Road", description: "Adult literacy programs, ESL classes, and GED preparation.", image: "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600&h=400&fit=crop", priceRange: "Free", isOpen: true, lat: 29.9615, lng: -95.6082 },
  { id: "biz_np_007", name: "Green Cypress Environmental", category: "Non-Profit", rating: 4.7, reviewCount: 9, address: "789 Earth Way", description: "Environmental conservation, tree planting, and community clean-ups.", image: "https://images.unsplash.com/photo-1542601906990-b4d3fb778b09?w=600&h=400&fit=crop", priceRange: "Free", isOpen: true, lat: 29.9833, lng: -95.6452 },
  { id: "biz_np_008", name: "Cypress Arts Council", category: "Non-Profit", rating: 4.5, reviewCount: 12, address: "234 Creative Blvd", description: "Promoting local arts through exhibitions, workshops, and community events.", image: "https://images.unsplash.com/photo-1460661419201-fd4cecdf8a8b?w=600&h=400&fit=crop", priceRange: "Free", isOpen: true, lat: 29.9675, lng: -95.612 },
