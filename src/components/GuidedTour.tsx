  ...
  return (
    <>
      ...
      <motion.button
        ...
        onClick={startTour}
        className="fixed bottom-6 right-6 z-[9998] w-14 h-14 rounded-2xl bg-navy-gradient text-gold flex items-center justify-center depth-shadow-lg hover:scale-110 transition-transform"
