...
const vertexShader = `
  ...
  void main() {
    ...
    float noise2 = snoise(position * 1.5 + uTime * uSpeed * 0.5);
    float displacement = noise * uNoiseStrength + noise2 * uNoiseStrength * 0.5;
    
    vec3 newPosition = position + normal * displacement;
    vNormal = normalize(normal + vec3(noise, noise2, noise) * 0.3);
